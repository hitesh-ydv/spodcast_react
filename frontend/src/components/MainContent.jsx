...
export default function MainContent() {
    ...
    const fetchAll = async () => {
      ...
      try {
        ...
        const [
          ...
          axios.get(`https://jiosavan-api-with-playlist.vercel.app/api/search?query=${encoded}`),
          axios.get(`https://jiosavan-api-with-playlist.vercel.app/api/search/songs?query=${encoded}&limit=20`),
          axios.get(`https://jiosavan-api-with-playlist.vercel.app/api/search/playlists?query=${encoded}&limit=20`),
          axios.get(`https://jiosavan-api-with-playlist.vercel.app/api/search/albums?query=${encoded}&limit=20`),
          axios.get(`https://jiosavan-api-with-playlist.vercel.app/api/search/artists?query=${encoded}&limit=20`)
        ]);
  ...
  return (
    <main className="flex-1 overflow-y-auto max-h-full max-w-full rounded-md bg-theme">
      <Routes>
        <Route
          path="/"
